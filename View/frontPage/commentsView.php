...
<div class="commentList">
	...
	foreach($getComments as $comment){
		echo '	<div class="comment">
					...
					<button type="button" id="'.$comment->getId().'" name="'.$_GET['id'].'" value="'.$comment->getAuthor().'" class="adminFunction report"><i class="fas fa-exclamation-triangle"></i><span class="styleText"> Signaler</span</button>
		...
		foreach(array_reverse($getComComments) as $comComment){
			echo '	<div class="comComment">
						...
						<button type="button" id="'.$comComment->getId().'" name="'.$_GET['id'].'" value="'.$comComment->getAuthor().'" class="adminFunction report"><i class="fas fa-exclamation-triangle"></i><span class="styleText"> Signaler</span</button>
						<button class="answerCom">Répondre</button>
						<div class="formComComment">
							<form action="" method="post">
								<label for="nom">Nom: </label>
